/**
 * Country code data for phone number selection
 * Contains country names, phone codes, and ISO codes
 */
...
/**
 * Gets the default country (Ghana) from the country codes data
 */
export const getDefaultCountry = () => countryCodesData.find(c => c.iso === 'GH');